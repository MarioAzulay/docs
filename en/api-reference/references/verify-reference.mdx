...
api: 'GET /v1/referencias/:numero/testar'
...
```bash
curl --request GET \
  --url https://api.izipay.ao/v1/referencias/100100100/testar \
...
class Program
{
    ...
    static async Task Main(string[] args)
    {
        try
        {
            var referenceNumber = "100100100"; // Replace with your reference number
            var uri = $"https://api.izipay.ao/v1/referencias/{referenceNumber}/testar";
